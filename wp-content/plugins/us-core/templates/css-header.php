...
.l-header.bg_transparent:not(.sticky) .<?= $class ?>.type_desktop .w-nav-item.level_1 > a:not(.w-btn):focus,
...
.l-subheader .w-nav.<?= $class ?>.type_mobile .w-nav-list.level_1 {
	background: <?= us_get_color( $param['color_mobile_bg'], /* Gradient */ TRUE ) ?>;
...
.no-touch .<?= $class ?>.type_mobile .w-nav-item.level_1:hover > a:not(.w-btn) {
	background: <?= us_get_color( $param['color_mobile_hover_bg'], /* Gradient */ TRUE ) ?>;
...
.<?= $class ?>.type_mobile .w-nav-item.level_1.current-page-ancestor > a:not(.w-btn) {
	background: <?= us_get_color( $param['color_mobile_active_bg'], /* Gradient */ TRUE ) ?>;
