	...
	$usof.FormElmsPreview.prototype = {
		...
		_getColorValue: function( name ) {
			if (
				...
				&& this.group.fields[ name ] !== undefined
				&& this.group.fields[ name ].type === 'color'
				&& this.group.fields[ name ].hasOwnProperty( 'getColorValue' )
			) {
				return this.group.fields[ name ].getColorValue();
			}
			return '';
		},
		/**
