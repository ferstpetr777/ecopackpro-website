    ...
    public function admin_notice() {
        ...
        if ( empty( $this->notice ) ) {
            $notice = sprintf(
                ...
                //identify bugs, improve performance, and prioritize new features
                $this->client->__trans( 'Help us improve <strong>%1$s</strong> even more awesome? By allowing us to collect usage and diagnostic data, you\'ll help us make the plugin faster, identify bugs, improve performance and better suited to your needs' ),
                $this->client->name
            );
        } else {
            $notice = $this->notice;
        ...
        $notice .= '<p style="display:none;" class="description description-data-we-collect">' . implode( ', ', $this->data_we_collect() ) . '. ';
        ...
        echo '</p></div><style>.description-data-we-collect{display: none;}</style>';
